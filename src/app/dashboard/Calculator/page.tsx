        ...
        <div className="mx-6">
          <div
            className={`bg-bar  rounded-[1rem] w-[${
              result * 2
            }rem] justify-center items-center relative p-6  border-4 border-contrast shadow-3xl  mt-28`}
          >
            {" "}
            <h2 className="text-3xl"> Wskaźnik poziomu zatłuszczenia:</h2>
            <div className="bg-black h-6 rounded-lg mt-10 relative w-full  shadow-3xl border-2 border-contrast ">
